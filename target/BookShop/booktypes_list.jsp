...
<div class="products">
    <div class="container">
        <h2><c:choose><c:when test="${empty t}">Tous les livres</c:when><c:otherwise>${t}</c:otherwise> </c:choose></h2>
                        ...
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            ...
                            <div class="b-wrapper">
                                <h4 class="b-animate b-from-left  b-delay03">
                                    <button  onclick="window.location.href='book_detail.action?bid=${g.bid}'">Voir les détails</button>
                                </h4>
                            </div>
                        </div>
                    </a>
